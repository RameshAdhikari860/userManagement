            ...
            <div className=" lg:ml-60" >
                ...
                <div className="bg-gray-100 min-h-screen py-8 px-4">
                    <div className="container mx-auto">
                        <h1 className="text-3xl font-bold text-center mb-8">Digital Marketer Daily Report</h1>
                            ...
                            <table className="w-full table-auto">
                                <thead>
                                    <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                        ...
                                        <th className="py-3 px-6 text-left">Total Calls</th>
                                        <th className="py-3 px-6 text-left">Total Bought</th>
                                        <th className="py-3 px-6 text-left">Total Interested</th>
                                ...
                                <tbody className="text-gray-600 text-sm">
                                    ...
                                    {reports.map((report, index) => (
                                        <tr key={index} className="border-b border-gray-200 hover:bg-gray-100">
                                            ...
                                            <td className="py-3 px-6 text-left">{new Date(report.createdAt).toLocaleDateString("en-CA")}{"   at"}{new Date(report.createdAt).toLocaleTimeString("hh-mm")}</td>
                                            <td className="py-3 px-6 text-left">{report.totalCalls}</td>
                                            <td className="py-3 px-6 text-left">{report.totalCoursesBought}</td>
                                            <td className="py-3 px-6 text-left">{report.totalInterested}</td>
                                            <td className="py-3 px-6 text-left">{report.remarks}</td>
                                            <td className="py-3 px-6 text-center">
                                                <div className="flex item-center justify-center">
                                                    <Link href={`/dashboard/viewDailyReport/${report._id}`}>
