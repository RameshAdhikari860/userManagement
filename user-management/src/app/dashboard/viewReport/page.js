    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                ...
                if (!token || token.data.roleName === 'DIGITAL MARKETER') {
                    router.push('/login');
                }
                ...
                const res = await axios.get(API_LINKS.GET_REPORT_BY_USER(token.data._id), { withCredentials: true })
                            ...
                            <table className="w-full table-auto">
                                <thead>
                                    <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                        ...
                                        {/* <th className="py-3 px-6 text-center">Actions</th>n */}
                                    </tr>
                                </thead>
